...
虎书 Ch12 Data Structures for Graphics 涵盖 BVH、BSP 树、均匀网格等多种空间加速结构，从数据结构的角度入门。[[pbrt]] Ch7 则聚焦 BVH 的工业级实现和 SAH 优化。
...
- [[pbrt]] — Chapter 7
- [[fcg]] — Ch12 Data Structures for Graphics（多种加速结构对比入门）
